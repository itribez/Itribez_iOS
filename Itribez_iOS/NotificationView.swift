...
struct NotificationView: View {
    ...
    let activity: NotificationModel
...
struct LikedNotificationView_Previews: PreviewProvider {
    static var previews: some View {
        NotificationView(activity: NotificationModel(activity: .liked,
                                             duration: "5h",
...
struct LikedNotificationView_Previews_Comment: PreviewProvider {
    static var previews: some View {
        NotificationView(activity: NotificationModel(activity: .comment,
                                             duration: "5h",
...
struct LikedNotificationView_Previews_SuggestedFollower: PreviewProvider {
    static var previews: some View {
        NotificationView(activity: NotificationModel(activity: .suggestFollower,
                                             duration: "6h",
...
struct LikedNotificationView_Previews_NewFollower: PreviewProvider {
    static var previews: some View {
        NotificationView(activity: NotificationModel(activity: .newFollower,
                                             duration: "18h",
