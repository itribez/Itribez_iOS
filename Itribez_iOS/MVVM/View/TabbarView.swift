                ...
                .overlay( // Overlay the custom TabView component here
                    (colorScheme == .dark ?  Color.black :  Color.white)// Base color for Tab Bar
                        ...
                        .overlay(HStack {
                            ...
                            Spacer()
                            TabbarItems(image: "createpost", isSystemImage: false, index: 2, selectedTabIndex: $selection, action: {
                                self.selection = 2
                            })
                            
                            Spacer()
                            TabbarItems(image: "notification", isSystemImage: false, index: 3, selectedTabIndex: $selection, action: {
                                self.selection = 3
                            })
                            Spacer()
